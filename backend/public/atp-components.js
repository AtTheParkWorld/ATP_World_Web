    ...
    host.innerHTML =
      '<footer role="contentinfo" class="atp-footer">' +
        '<div class="atp-footer-inner">' +
          '<div class="atp-footer-top">' +
            '<div class="atp-footer-brand">' +
              '<img loading="lazy" decoding="async" src="' + escapeHtml(LOGO_SRC) + '" alt="At The Park" style="height:26px;width:auto;display:block;margin-bottom:14px">' +
              '<p class="atp-footer-tagline">Changing the world\'s fitness — one free session at a time. Dubai · Al Ain · Muscat. Est. 2015.</p>' +
          ...
          '<div class="atp-footer-bottom">' +
            ...
            '<nav class="atp-footer-legal" aria-label="Account">' +
              authMarkup() +
            '</nav>' +
          '</div>' +
        '</div>' +
