...
(function() {
  ...
  window.showAdminSection = function(name, btn) {
    ...
    if (name === 'sessions')   { loadCities(); loadCoaches(); loadTribes(); loadActivitiesForSession(); loadAmbassadorsForSession(); if (typeof loadSessionTemplates === 'function') loadSessionTemplates(); setTimeout(loadSessionsList, 200); }
