...
function _libraryUploadHeader() {
  return '<div style="background:#0d1a0a;border:1px solid #1f3a0d;border-radius:12px;padding:16px;margin-bottom:18px;display:flex;align-items:center;gap:14px;flex-wrap:wrap">' +
    '<div style="flex:1;min-width:200px">' +
      ...
      '<div style="font-size:11px;color:#888;line-height:1.5">Drop images or videos here \u2014 they\u2019ll appear below and can be reused on any page. Max <strong>10&nbsp;MB</strong>. Click <strong>📁 Image</strong> below for the full size-by-slot guide. Quick version: WebP or JPG at quality 80, no wider than 1920&nbsp;px, PNG only when you need transparency.</div>' +
    '</div>' +
